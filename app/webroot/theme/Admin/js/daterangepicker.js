        ...
        var DRPTemplate = '<div class="daterangepicker dropdown-menu">' +
                ...
                '<div class="ranges">' +
                  '<div class="range_inputs">' +
                    ...
                    '</div>' +
                    '<button class="' + this.applyClass + ' applyBtn btn-block" disabled="disabled">' + this.locale.applyLabel + '</button>' +
                    //'<button class="' + this.cancelClass + ' cancelBtn btn-block">' + this.locale.cancelLabel + '</button>' +
                    '<button class="clearBtn btn-default btn-block">' + this.locale.clearLabel + '</button>' +
                  '</div>' +
                '</div>' +
              '</div>';
